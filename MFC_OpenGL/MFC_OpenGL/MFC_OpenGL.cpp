...
// MFC_OpenGL.cpp : Defines the class behaviors for the application.
//
...
// The one and only CMFC_OpenGLApp object

CMFC_OpenGLApp theApp;


// CMFC_OpenGLApp initialization
